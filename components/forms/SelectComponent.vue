<template>
  <Listbox v-model="selectedoption">
    <div class="relative w-full" :class="containerStyle">
      <ListboxButton
        :class="classStyles"
        class="relative w-full cursor-default rounded-full min-h-[40px] border border-[#868685] bg-white p-6 pr-8 text-left shadow-[0px_1px_2px_rgba(16,24,40,0.05)] sm:text-[14px] flex items-center"
      >
