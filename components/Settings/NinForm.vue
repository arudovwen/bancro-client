<template>
  <form @submit.prevent="onSubmit" v-if="active == 1" class="p-2 w-[420px]">
    <legend class="text-xl font-semibold mb-6 block text-[#344054]">NIN</legend>
  ...
  <TransactionsStatus
   v-if="active == 3"
    title="NIN Linked"
    text="Your NIN has been successfully liked to your account"
  />
</template>
<script setup>
...
const schema = yup.object({
  nin: yup.string().required("Provide your NIN"),
});
