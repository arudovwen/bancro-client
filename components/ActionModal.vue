            ...
            >
              ...
              >
                <div class="bg-white px-6 py-6">
                  ...
                  >
                    <h3 class="text-sm font-semibold mb-3 text-[#454745]">
                      Payment Summary
                    </h3>
                  ...
                  <div class="flex gap-x-4 items-center mt-6">
                    <button
                      ...
                      type="button"
                      @click="handleclose"
                      class="h-11 appearance-none leading-none px-4 py-[10px] rounded-lg text-matta-black hover:bg-gray-100 text-sm w-full border border-[#868685] font-medium justify-center flex items-center"
                    >
                      Cancel
                    </button>
