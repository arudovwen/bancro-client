                ...
                <div class="bg-white px-6 py-6">
                  ...
                  <div class="flex flex-col gap-y-4 items-center mt-6">
                    <button
                      ...
                      type="button"
                      @click="deleteItem"
                      class="appearance-none leading-none px-4 py-[14px] rounded-lg text-white bg-[#D92D20] text-sm w-full border border-[#D92D20] font-medium disabled:opacity-50"
                    >
                      {{ btnText }}
                    </button>
                    <button
                      type="button"
                      @click="handleclose"
                      class="appearance-none leading-none px-4 py-[14px] rounded-lg text-matta-black hover:bg-gray-100 text-sm w-full border border-[#868685] font-medium"
                    >
                      Cancel
                    </button>
                  </div>
